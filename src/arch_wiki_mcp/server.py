...
# The `--check` machinery is its own module now (registration.py). main() wires it in
# below; everything else about it -- discovery, matching, the handshake diagnosis --
# is reached as `registration.X`, where it lives.
